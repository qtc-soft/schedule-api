...
sys.path.append(
    os.path.abspath(os.path.join(os.path.abspath(__name__), os.pardir))
)

from settings import config, init_settings
...
def run_migrations_offline():
    ...
    url = 'postgresql://%s:%s@%s/%s' % (
        config.get('DB', 'user'), config.get('DB', 'password'), config.get('DB', 'host'), config.get('DB', 'database'))
